...
setTimeout( () => {
m.reply(`*.Safari o .safari:* Informacion de los proximos safari zone\n\n*.cd o .Cd:* informacion de los proximos dias de la comunidad\n\n*.HraDes o . hrades:* informacion de las proximas horas destacadas\n\n*.HraLeg o .hraleg:* informacion de kas proximas horas legendarias*\n\n*.Capi o .capi:* comparte el ultimo capitulo del anime\n\n *.sticker:* usalo para covertir una imagen en sticker, tambien funciona con videos de menos de 10 segundos de duracion. \n\n *.aimg:* te ayuda a convertir cualquier sticker a imagen \n\n *.djbot:* envia un archivo con musica random (evita abrir el enlace de yotube y solo descarga el audio que ebvia) \n\n *PROXIMAMENTE MAS COMANDO*😎🤝`)
}, 2500)
m.limit = 0
}
...
m.reply (media: "https://f5r3t3y3.rocketcdn.me/wp-content/uploads/2022/10/pokemon-go-november-2022-events-guzzlord.jpg")
}, 2500)
m.limit = 0
}
